...
export default function EnsembleBookingsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/coaches"><Button>Book a Coach</Button></Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <Link href="/coaches"><Button variant="outline" className="mt-3">Browse Coaches</Button></Link>
        </div>
      ) : (
              ...
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="py-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-semibold text-gray-900">{booking.coach.fullName}</p>
